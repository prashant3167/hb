...
//            console.log(constant_fields);
        ...
        $.getJSON("full.json", function(json) {
            ...
            total_core = total_core + parseFloat((conf[0]/30.0).toFixed(3));
            total_ram = total_ram + parseFloat((ram_need(Math.ceil(conf[0]))/30).toFixed(3));
            total_storage = total_storage + parseFloat((conf[1]/30).toFixed(3));
            ...
            var table_entry = "<tr><td style=\"width:9%\">" + (++col_count) + "</td><td style=\"width:6%\">" + device_count + "</td><td style=\"width:9%\">" + data + "</td><td style=\"text-align:left;width:40%\">" + playbooks + "</td><td style=\"width:13%\">" + counts + "</td><td id=\"calculated_result\" style=\"width:5%\">" + (conf[0]/30).toFixed(3) + "</td><td id=\"calculated_result\" style=\"width:9%\">" + (ram_need(Math.ceil(conf[0]))/30).toFixed(3) + "</td><td id=\"calculated_result\" style=\"width:9%\">" + (conf[1]/30).toFixed(3) + "</td></tr>";
